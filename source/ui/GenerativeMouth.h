...
private:
    ...
    void generateNextFrame()
    {
        ...
        // Audio activity expands opening (additive, not multiplicative)
        openNorm = juce::jlimit (0.3f, 0.95f, openNorm + audioLevel * 0.4f);

        // Morph can subtly influence shape (optional)
        widthNorm = juce::jlimit (0.4f, 0.95f, widthNorm * (0.9f + 0.2f * morphValue));
