...
public:
    ...
    void renderOpenGL() override
    {
        ...
        juce::Graphics g{ juce::Image() }; // Null image for placeholder graphics context (use braces to avoid most vexing parse)
...
private:
    ...
    juce::Graphics glRenderGraphics_{ juce::Image() }; // Placeholder graphics context
